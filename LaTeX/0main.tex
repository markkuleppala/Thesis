...
\usepackage[finnish,english]{babel} % Try english if not working
...
\newcommand{\FTITLE}{Software Processes for Dummies}
\newcommand{\FDATE}{Helmikuu 14, 2018}
...
are giving in the \texttt{thesis.tex} file as comments and also in this pdf
in a Section~\ref{section:compilation}.}
