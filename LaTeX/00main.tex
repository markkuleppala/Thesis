...
Viimeiset 10 vuotta olen keskittynyt oppimiseen. Kun ehkä ne tärkeimmät oppirahat löytää jostain muualta, jäävät akateemiset ansiot syrjään. On kuitenkin aika saattaa nämä akateemiset opit syrjään, hetkeksi. Voittajia eivät ole ne, jotka ovat oppineet tarpeeksi, vaan ne, jotka eivät koskaan lopeta oppimista. Diplomityön loppuunsaattaminen on ollut itselleni tärkeä saavutus, mutta oppiminen ei jää tähän.

Viimeiset vuodet ovat olleet matka, joka on taitettu yhdessä. Matkalla on tavoite, mutta määränpäässä huomaa palkinnon olevan itse matka eli kokemukset ja ihmissuhteet. Haluankin kiittää tukijoitani sekä sidosryhmiä, jotka tekivät opiskelusta siedettävää, ja ehkä liiankin kestettävää.

Kiitoksia ohjaajalleni Jan Zizkalle ehtymättömästä tuesta ja avustavasta otteesta. Apusi työn osalta on ollut kullanarvoista, antaen oppeja niin työhön kuin muuhunkin elämään. Kiitokset Markku Niiraselle esimiehenä olemisesta ja mukaan ottamisesta Nokian yhteisöön. Haluan myös kiittää valvojaani Jukka Mannerta asiaankuuluvista kommenteista sekä opastamisesta työn muotoilussa.
...
\input{2cloudcomputing.tex}

\input{3katacontainers.tex}
