...
% ------------------------------------------------------------------
\newcommand{\TITLE}{IO Performance of Secure Container Runtime in Far Edge Cloud}
\newcommand{\DATE}{Toukokuu 30, 2021}

\newcommand{\FTITLE}{Turvallisten ohjelmakonttien datasiirrännän suorituskyky etäisessä reunapilvessä}
\newcommand{\FDATE}{Toukokuu 30, 2021}
...
\newcommand{\KEYWORDS}{Kata Containers, Far Edge Cloud, Mobile Edge Computing, Container, Security, IO performance}
\newcommand{\FKEYWORDS}{}
...
Welcome to read author Leppälä's inaugural opus!
